...
namespace Repository.SQL.Migrations
{
    ...
    [Migration("20200617141016_UserFavorites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.SQL.FavoriteEventListStorage", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("EventListJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApp.StorageModels.PictureStorageModel", b =>
                {
                    b.HasOne("WebApp.StorageModels.EventStorageModel", "Event")
                        .WithMany("Pictures")
